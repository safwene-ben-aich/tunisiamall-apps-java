...
package src.InterfaceUtilisateur;
...
*/	
	...
	// D�claration des m�thodes
		...
		/** M�thode d�clench�e apr�s appel de '_t.start()', son r�le consiste � lire et afficher les messages envoy�s par le serveur*/
	 	//Il s'agit principalement des messages envoy�s par les autres utilisateurs (clients) */
		...
		public void run(){
			try{
				while(true){
					...
					// 1. R�cup�rer le flux d'entr�e de la socket s (m�thode getInputStream() de la classe Socket)
					InputStream is = s.getInputStream ();
	      	  		ObjectInputStream ois = new ObjectInputStream (is);

					// 2. Lire le type de message envoy� par le serveur (m�thode bloquante, par exemple : readObject())
					Object obj = ois.readObject();                
	         		

					// 3. Convertir l'objet ('Object') re�u en une chaine de caract�res ('String')
					...
					// 4. Lire le  message envoy� par le serveur (m�thode bloquante, par exemple : readObject())
					obj = ois.readObject();
		...
		public void deconnecter(){
	      ...
	      /** M�thode permettant d'introduire le num�ro de port surveill� par le serveur */          
	   	public void setPort(int _port){
	   		this.port=_port;
	    	}

	   	/** M�thode permettant de retourner la message recue */          
		public String getMsgRecue(){
			return this.msgRecue;
		}
		/** M�thode permettant de mmodifier la message recue */          
		...
		/** M�thode permettant de retourner la message envo */          
		public String getMsgE1(){
			return this.msgE1;
		}
		/** M�thode permettant de mmodifier la message  */          
		public void setMsgE1(String s){
			this.msgE1=s;
		}
		
		/** M�thode permettant de retourner le login du destinataire */          
		public String getLoginDestination(){
			return this.loginDestination;
		}
		/** M�thode permettant de mmodifier le login du destinataire */          
		public void setLoginDestination(String s){
			this.loginDestination=s;
		}/** M�thode permettant de retourner l @IP du destinataire */          
		public String getAdrIPDestination(){
			return this.ipDestination;
		}
		/** M�thode permettant de mmodifier l @IP du destinataire */          
		public void setAdrIPDestination(String s){
			this.ipDestination=s;
		}
		/** M�thode permettant de retourner le num�ro de port du serveur */          
	    	public int getPort(){
			return this.port;
	    	}

	  	/** M�thode permettant d'introduire le nom ou l'IP du serveur */          
		...
		/** M�thode permettant de retourner l'adresse IP du serveur */ 
	   	public InetAddress getInetAddress(){
	        return this.inetAddress;
	    	}

		/** M�thode permettant d'introduire le login de l'utilisateur */ 
		...
		/** M�thode permettant d'introduire le login du client login<>" " */          
